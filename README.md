...
**① 상대방의 어려움을 그냥 지나치지 않고, 함께 고민합니다.**

데브코스 Wibby 프로젝트에서 코드 리뷰를 담당하며 팀원들의 코드를 검토하던 중, 여러 팀원이 객체지향 설계의 핵심 개념인 추상화를 이해하고 <br>
적용하는 데 어려움을 겪고 있다는 점을 발견했습니다. 수정 사항을 전달하는 데 그치지 않고 실제 코드 사례를 중심으로 발표한 경험이 있습니다.

**② 기술에 대한 탐구를 즐깁니다.**

기술을 단순히 사용하는 데 그치지 않고, 동작 원리와 그 이유를 이해하려 노력합니다. 알고리즘 스터디를 통해 다양한 문제를 꾸준히 해결하며 최적화 역량을 쌓았고, 이를 바탕으로 삼성 S/W B형을 취득했습니다. 또한 데브코스에서는 학습 과정에서 생긴 궁금증을 그냥 넘기지 않고 직접 찾아보고 질문하며 이해를 넓혔습니다. 이러한 적극적인 학습 태도를 인정받아 교육생 투표에서 최다 득표로 ‘질문왕’에 선정되었습니다.
